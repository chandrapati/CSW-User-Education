...
| [chandrapati/CSW-Epic-Microsegmentation-Guide](https://github.com/chandrapati/CSW-Epic-Microsegmentation-Guide) | When the customer runs Epic EHR — phased playbook for Epic tier labels, ADM, policy modeling, and enforcement (Hyperspace, Clarity, Caboodle, Mirth, and related tiers). |
